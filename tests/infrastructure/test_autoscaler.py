...
from app.services.runtime_ops import autoscaler_idle_scale_down_healthy, reconcile_gpu_pool
...
def test_idle_scale_down_health_is_false_for_expired_extra_idle_leases() -> None:
    ...
    repo.upsert_gpu_lease(
        ...
        payload={
            ...
            "metadata": {"desired_warm_instances": settings.gpu_pool_min_warm_instances},
            "allocated_at": None,
            "released_at": (now - timedelta(seconds=settings.gpu_pool_idle_timeout_seconds + 60)).isoformat(),
